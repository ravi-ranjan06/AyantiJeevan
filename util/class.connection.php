...
class Connection
{
	...
	public function __construct()
	{
		...
		define('VERSION','2.0');
		define('BUILD','25122018');
		define('DB_NAME', 'ayantijeevan');
		define('LANGUAGE', 'en');
		define('SERVER_ROOT', $_SERVER['DOCUMENT_ROOT']);
		define('DS', '/');
		define('APP_ROOT', 'AyantiJeevan');
		...
		define('PAGE_TITLE', 'AyantiJeevan');
	}
	...
	/*public function select($table_name,$orderby = "",$limit = "")
	{
		$query = "SELECT * FROM $table_name $orderby $limit";
